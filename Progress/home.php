...
<?php include_once 'navigation.php';?>
  ...
  <div class="BackgroundHeader">
      <div class="row animatedParent">
          <h2 class="h-bold animated fadeIn slower">What is Capstone </h2>
      </div>
    ...
    <div class="container">
      <div class="row animatedParent">
        <div class="col-lg-8 col-lg-offset-2 animatedParent">
          <div class="text-center animated fadeIn slower">
            <p>
            ...
            <div class="animated rotateInDownLeft fast">
              <div class="service-box">
                <div class="service-desc">
                  ...
                  <div class="divider-header"></div>
                  <p>
                  The three may seem similar, however Capstone is much more beneficial to both students and sponsors. Click below to view a complete comparison
                  </p>
                  <a href="file/How is the capstone different.pdf" target="_blank" class="btn btn-skin">Compare</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row animatedParent">
        <div class="col-sm-12 col-md-12 col-lg-12">
          <div class="row">
            ...
            <img src="img/logos/awis.png" class="logogallery"/></a>
            <a href="http://baratfoundation.org/">
            <img src="img/logos/barat.png" class="logogallery"/></a>
            <a href="https://www.bctpartners.com/">
            <img src="img/logos/bct.jpg" class="logogallery"/></a>
            <a href="http://beachboxnow.com/">
            <img src="img/logos/beachbox.jpg" class="logogallery"/></a>
            <a href="http://d3uc.com/">
            <img src="img/logos/d3unified.jpg" class="logogallery"/></a>
            <a href="https://www.isc2.org/">
            <img src="img/logos/isc2.png" class="logogallery"/></a>
            <a href="http://www.netatwork.com/">
            <img src="img/logos/net@work.jpg" class="logogallery"/></a>
            <a href="https://www.judiciary.state.nj.us/">
            <img src="img/logos/njcourts.png" class="logogallery"/></a>
            <a href="http://pullupapp.io/">
            <img src="img/logos/pullup.png" class="logogallery"/></a>
            <a href="http://www.rde.org/">
            <img src="img/logos/rde.png" class="logogallery"/></a>
            <a href="https://www.ups.com/us/en/global.page">
            <img src="img/logos/ups.jpg" class="logogallery"/></a>
            <a href="https://sharewefi.com/">
            <img src="img/logos/wefi.png" class="logogallery"/></a>
            <a href="https://www.yai.org/">
            <img src="img/logos/yai.jpg" class="logogallery"/></a>
          </div>
        </div>
      </div>
    </div>
